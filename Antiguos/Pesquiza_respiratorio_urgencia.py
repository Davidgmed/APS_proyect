...
import numpy as np
from selenium.webdriver.chrome.service import Service  # Asegúrate de importar Serviceupport import expected_conditions as EC
import numpy as np
...
fecha_inicio = fecha_actual - timedelta(days=16)
...
credentials = ServiceAccountCredentials.from_json_keyfile_name(r'G:\Mi unidad\quantum-balm-400521-65b53594e910.json', scope)
